...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ('id',)  # role is now writeable for registration if needed, or we keep it read-only and admin assigns?
        # User requested rebuild. Let's allow role selection for now or default to customer.
        # If we want to allow vendor registration:
        extra_kwargs = {
            'email': {'required': True},
    ...
    def create(self, validated_data):
        ...
        # Default to customer if not provided, or logic to handle vendor approval
