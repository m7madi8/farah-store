...
from .permissions import IsAdmin, IsVendor, IsCustomer, IsOwnerOrAdmin
...
class VendorOnlyView(APIView):
    """GET /api/auth/vendor-check/ — Only accessible by Vendors/Admins."""
    permission_classes = [IsVendor]

    def get(self, request):
        return Response({'detail': f'Welcome {request.user.full_name}, you have vendor access!'})
